...
| 🏅 Elastic 데이터콘서트 TOP 4                      | 🌐 UMC WEB 챌린저 & 파트장                           | 🤝 FE Leader                                                |
| -------------------------------------------------- | ---------------------------------------------------- | ----------------------------------------------------------- |
| 데이터 경진대회에서 실전 감각과 분석력을 다졌어요. | 7기부터 9기까지 프론트엔드 리더십을 이어가고 있어요. | 여러 서비스에서 프론트엔드를 이끌며 협업 경험을 쌓았습니다. |
...
<div align="center">
  <table>
    ...
    <tr><td>2025.09.02</td><td>🏅 오픈소스 개발자대회 <b>TOP 22</b></td></tr>
